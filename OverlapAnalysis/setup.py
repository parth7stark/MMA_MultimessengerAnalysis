...
setuptools.setup(
    name="mma_overlap_estimation",
    version="1.0.0",
    author=AUTHOR,
    description="An open-source package for peforming overlap analysis of ThetaObs and DL from Dingo and Afterglowpy",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/parth7stark/MMA_MultimessengerAnalysis/tree/main/OverlapAnalysis",
    project_urls={
        "Bug Tracker": "https://github.com/parth7stark/MMA_MultimessengerAnalysis/tree/main/OverlapAnalysis/issues",
    },
    classifiers=[
